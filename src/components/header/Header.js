          ...
          .then(doc => {
            if (doc.exists) {
              ...
              db.collection("users")
                ...
                .catch(() => {
                  window.M.toast({
                    html: "Unable to create your account. Please, try again"
                  });
                });
            }
          })
    ...
    return (
      <div>
        ...
        >
          ...
          <div
            class="modal-content center-align"
            style={{
              padding: "35px"
            }}
          >
            ...
            >
              <i class="fab fa-google" style={{ marginRight: "10px" }} />
            ...
            >
              <i class="fab fa-facebook-f" style={{ marginRight: "10px" }} />
